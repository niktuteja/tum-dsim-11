 ...
 * 
 * Exponential class Generates exponential distributed samples
 * 
...
public class Exponential extends RandVar {
	...
	/**
	 * Constructor of the Exponential class lambda is initialized with the value
	 * 1 => mean = 1
	 */
	public Exponential() {
		lambda = 1;
	 ...
	 *            the lambda value
	 */
	public Exponential(double la, Rng rng) {
		lambda = la;
		this.rng = rng;
	}
