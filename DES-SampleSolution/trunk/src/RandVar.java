...
abstract class RandVar
{
	...
	/**
	 * Abstract methode type() shall return the name of the distribution 
	 */
	...
	/**
	 * Abstract methode getRV() returns uniform distributed samples
	 */
	public abstract double getRV();
	/**
	 * Abstract methode returns the greatest long that is smaller than the sample+0.5
	 */
	...
	/**
	 * Function sets the variance according to given parameter if the parameter is greater than zero
	 *@param v new value of the variance
	 */
	...
	/**
	 * Function sets the variation coefficient according to the given parameter c.
	 * If the mean is equal to zero nothing is done.
	...
	/**
	 * Abstract function setMean(double) has to be implemented by extending classes
	 *@param m the value to set
	 */
	public abstract void setMean (double m);
	/**
	 * Abstract function setStdDeviation(double) has to be implemented by extending classes
	 *@param s the value to set
	 */
	public abstract void setStdDeviation(double s);
	/**
	 * Abstract function setMeandAndStdDeviation(double,double) has to be implemented by extending classes
	 *@param m the value to set
	 *@param s the value to set
	 */
	public abstract void setMeanAndStdDeviation(double m, double s);
	/**
	 * Function sets the mean and variation coefficient according to the given parameters.
	 *@param m the value to set
	 *@param s the value to set
	 */
