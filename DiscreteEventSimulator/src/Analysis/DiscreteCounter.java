...
/**
 * DiscreteCounter class Class just counts the given values without regarding
...
public class DiscreteCounter extends Counter {
	 ...
	 * initialize the DiscreteCounter
	 * 
	 * @param oVariable
	...
	public double getVariance() {
		if (numSamples > 1) {
			...
			return numSamples / (double) (numSamples - 1)
	...
	/**
	 * Method calculaties and retuns the standard deviation of the observed variable
	 * 
	 * @return the calculated time independent standard deviation
	 */
